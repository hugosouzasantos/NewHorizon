...
<body>
	...
	<div
		...
		<h2 Style="text-align: center;">Os Dados do Cliente ${cliente.nome} Foram Atualizados.</h2>
	</div>
	...
	<div style="text-align: center; padding-bottom: 3%">
		<a href="controlador?action=gerenciarCliente"><button type="button" class="btn btn-outline-primary">Pagina inicial</button></a>
	</div>
</body>
</html>