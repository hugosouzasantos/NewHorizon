...
<div Style="background-color: #69d1ce; padding: 2%; height: 5%; box-shadow: 0px 2px 2px #488a88;"><h2 Style="text-align: center;">Login Vendedor</h2></div>
...
<form action="controlador?action=confirmLoginVendedor" method="post" Style="padding-left: 5%; padding-right: 5%; padding-top: 2%; padding-bottom: 2%;">
  ...
  <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label" for="senhaVendedor">Senha</label> <input type="password"
                    class="form-control" id="senhaVendedor" name="senhaVendedor" placeholder="********">
            </div>
