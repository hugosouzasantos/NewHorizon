...
@WebServlet("/dadosvendedor")
public class dadosvendedor extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String plataformaprincipal = request.getParameter("plataforma");
		...
		out.print("<head>\r\n"
				...
				+ "<body>\r\n"
				+ "\r\n"
				+ "	<h2 style=\"text-align: center; margin-top: 2%;\">Dados do vendedor:</h2>\r\n"
				+ "\r\n"
